...
data=pd.read_csv('combined1.01.csv',encoding='utf-8',engine='python')
...
for i in range(10,50,1):
    ...
    for j in [0.5]:
        ...
        for k in range(100):
           ...
           X_train, X_test, y_train, y_test = train_test_split(X_skernpca, y, test_size=0.25, random_state=k)
           clf1 = XGBClassifier()
